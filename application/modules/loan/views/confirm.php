        ...
        <div class="leftbar">
            ...
            <div class="sidebar">
                ...
                <div class="logobar">
                    ...
                    <a href="<?=base_url()?>l" class="logo logo-small"><img src="<?=base_url()?>assets/fmb.jpg" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End Logobar -->
                <!-- Start Navigationbar -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-5 col-lg-5">
                                                <div class="invoice-name">
                                                    <h5 class="text-uppercase mb-3">Confirmation Slip</h5>
                                                    <p class="mb-1">No :<?=$key?></p>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <div class="invoice-footer-btn">
                                                     <a href="<?=base_url()?>loan/cancel/<?=$key?>" class="btn btn-danger-rgba py-1 font-16"><i class="feather icon-delete mr-2"></i>Cancel</a>
                                                    <a href="javascript:window.print()" class="btn btn-primary-rgba py-1 font-16"><i class="feather icon-printer mr-2"></i>Print</a>
                                                    <a href="<?=base_url()?>loan/accept/<?=$key?>" class="btn btn-success-rgba py-1 font-16"><i class="feather icon-send mr-2"></i>Submit</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                   
