                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title" style="text-align: center;">Loan</h5>
                            </div>
                            <div class="card-body">
                                
                                <form method="post" action="<?=base_url()?>admadmin/paid_loan_small/<?=$key?>">
                                <div class="form-group mb-0">
                                    <label for="inputEmail4">Amount Paid</label>
                                    <input type="number" class="form-control" name="value" required id="inputText" placeholder="Text value">
                                    <br/>
