            ...
            <div class="sidebar">
                ...
                <div class="navigationbar">
                    <ul class="vertical-menu" style="font-size:21px !important; ">
                        ...
                        <li>
                            <a href="<?=base_url()?>admadmin/home" >
                                <img src="<?=base_url()?>assets/dashboard/assets/images/svg-icon/home.svg" class="img-fluid" alt="home"><span>Admin Home</span>
                            </a>
                            
                        </li>

                        <li>
                            <a href="<?=base_url()?>admadmin/users">
                                <img src="<?=base_url()?>assets/dashboard/assets/images/svg-icon/user.svg" class="img-fluid" alt="Account"><span>All Users</span>
                            </a>
                            
                        </li>

                        <li>
                            <a href="<?=base_url()?>admadmin/manage_loan">
                                <img src="<?=base_url()?>assets/dashboard/assets/images/svg-icon/form_elements.svg" class="img-fluid" alt="Account"><span>Manage Loan</span>
                            </a>
                            
                        </li>
                        
                        <li>
                            <a href="<?=base_url()?>admadmin/logout">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title" style="text-align: center;">Pending Accounts</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="default-datatable" class="display table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$row->phone?></td>
                                                <td><?=$row->job?></td>
                                                <td><a href="<?=base_url()?>admadmin/view_user/<?=$row->id?>" class="btn btn-primary font-16"><i class="feather icon-document mr-2"></i>View</a></td>
                                                <td><a href="<?=base_url()?>admadmin/delete_user/<?=$row->id?>" class="btn btn-danger font-16"><i class="feather icon-delete mr-2"></i>Delete</a></td>
                                            </tr>
                                                <?php } ?>
            ...
            <div class="contentbar">                
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title" style="text-align: center;">Loan Request</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="<?php echo base_url()?>documents/loan/<?=$row2->collateral?>" target="_blank" style = "font-size: 18px;" > View Collateral</a></td>

                                            <td><a href="<?php echo base_url()?>documents/loan/<?=$row2->collateral2?>" target="_blank" style = "font-size: 18px;" > View Collateral 2</a></td>

                                            <td><a href="<?=base_url()?>admadmin/loan_approve/<?=$row2->id?>" class="btn btn-success font-16"><i class="feather icon-check mr-3"></i>Approve</a></td>

                                            <td><a href="<?=base_url()?>admadmin/loan_reject/<?=$row2->id?>" class="btn btn-danger font-16"><i class="feather icon-x mr-3"></i>Reject</a></td>
