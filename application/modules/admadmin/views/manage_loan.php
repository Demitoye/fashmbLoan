                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title" style="text-align: center;">All Approved Loans</h3>
                            </div>
                            <div class="card-body">
            ...
            <div class="contentbar">                
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title" style="text-align: center;">Paid Loan Back</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=base_url()?>admadmin/paid_loan_fully/<?=$row2->id?>" class="btn btn-success-rgba py-1 font-16"><i class="feather icon-check mr-2"></i>YES</a></td>

                                            <td><a href="<?=base_url()?>admadmin/paid_loan_small/<?=$row2->id?>" class="btn btn-success-rgba py-1 font-16"><i class="feather icon-check mr-2"></i>YES</a></td>
                                            <td><a href="<?=base_url()?>admadmin/not_paid/<?=$row2->id?>" class="btn btn-success-rgba py-1 font-16"><i class="feather icon-check mr-2"></i>YES</a></td>
            ...
            <div class="contentbar">              
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h3 class="card-title" style="text-align: center;">Due Loans For <?=Date('d-m-Y');?></h3>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="datatable-buttons" class="display table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td><?=$count++?></td>
                                            <td><?=$row3->unique_code?></td>
                                            <td><?=$row3->amount?></td>
                                            <td><?=$row3->expected_payment?></td>
                                            <td> <?=$row3->date?> </td>

                                            <td><?=$row3->return_date?></td>

                                            <td style="background-color:<?=$color?>; color: white;"><?=$loan_status?></td>
                                            <td> <a href="<?=base_url()?>admadmin/change_status/<?=$row3->id?>" class="btn btn-success-rgba py-1 font-16"><i class="feather icon-check mr-2"></i>YES</a></td>
