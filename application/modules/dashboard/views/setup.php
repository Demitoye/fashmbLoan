            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <h4 class="page-title">Complete Registration</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title" style="text-align: center;">Complete Registration</h5>
                            </div>
                            <div class="card-body">

                                <form action="<?=base_url()?>/dashboard/Setup" method="post" enctype = "multipart/form-data">

                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputEmail4">Passport</label>
                                            <input type="file" class="form-control" id="inputEmail4" name= "passport"  accept=".png, .jpg, .jpeg, .pdf"  required >
                                        </div>
                                         <div class="form-group col-md-4">
                                            <label for="inputEmail4">Identity Card</label>
                                            <input type="file" class="form-control" id="inputEmail4" name= "id_card" accept=".png, .jpg, .jpeg, .pdf" required>
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="inputEmail4">PHCN Bill</label>
                                            <input type="file" class="form-control" id="inputEmail4" accept=".png, .jpg, .jpeg, .pdf" name= "phcn" required>
                                        </div>
                                    </div>
