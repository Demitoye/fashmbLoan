                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-header">
                                <h5 class="card-title" style="text-align: center;">Change Password</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="Password" class="form-control" name="old_password" required id="inputText" placeholder="Text value">
                                    <br/>
                                </div>

                                      <div class="form-group col-md-6">
                                            <label for="inputEmail4">New Password</label>
                                            <input type="Password" class="form-control" name="new_password1" required id="inputText" placeholder="Text value">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Confirm Password</label>
                                            <input type="Password" class="form-control" name="new_password2" required id="inputText" placeholder="Text value">
                                        </div>
                                        </div>
